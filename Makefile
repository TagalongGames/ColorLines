...
OBJECTFILES_RELEASE_GUI_MODULES=    $(OBJ_RELEASE_DIR)\EntryPoint$(FILE_SUFFIX_GUI).o     $(OBJ_RELEASE_DIR)\ColorLinesWndProc$(FILE_SUFFIX_GUI).o $(OBJ_RELEASE_DIR)\Scene$(FILE_SUFFIX_GUI).o $(OBJ_RELEASE_DIR)\Stage$(FILE_SUFFIX_GUI).o $(OBJ_RELEASE_DIR)\DisplayError$(FILE_SUFFIX_GUI).o     
OBJECTFILES_DEBUG_GUI_MODULES=      $(OBJ_DEBUG_DIR)\EntryPoint$(FILE_SUFFIX_GUI).o       $(OBJ_DEBUG_DIR)\ColorLinesWndProc$(FILE_SUFFIX_GUI).o   $(OBJ_DEBUG_DIR)\Scene$(FILE_SUFFIX_GUI).o   $(OBJ_DEBUG_DIR)\Stage$(FILE_SUFFIX_GUI).o   $(OBJ_DEBUG_DIR)\DisplayError$(FILE_SUFFIX_GUI).o       
...
$(OBJ_RELEASE_DIR)\ColorLinesWndProc$(FILE_SUFFIX_GUI).asm: $(OBJ_RELEASE_DIR)\ColorLinesWndProc$(FILE_SUFFIX_GUI).c
	$(GCC_COMPILER) $(GCC_COMPILER_PARAMETERS_RELEASE) $(OBJ_RELEASE_DIR)\ColorLinesWndProc$(FILE_SUFFIX_GUI).c -o $(OBJ_RELEASE_DIR)\ColorLinesWndProc$(FILE_SUFFIX_GUI).asm
...
$(OBJ_RELEASE_DIR)\Scene$(FILE_SUFFIX_GUI).asm: $(OBJ_RELEASE_DIR)\Scene$(FILE_SUFFIX_GUI).c
	$(GCC_COMPILER) $(GCC_COMPILER_PARAMETERS_RELEASE) $(OBJ_RELEASE_DIR)\Scene$(FILE_SUFFIX_GUI).c -o $(OBJ_RELEASE_DIR)\Scene$(FILE_SUFFIX_GUI).asm
...
$(OBJ_RELEASE_DIR)\Scene$(FILE_SUFFIX_GUI).c: Classes\Scene.bas Classes\Scene.bi Classes\Stage.bi
...
$(OBJ_DEBUG_DIR)\Scene$(FILE_SUFFIX_GUI).c:   Classes\Scene.bas Classes\Scene.bi Classes\Stage.bi
...
$(OBJ_RELEASE_DIR)\Stage$(FILE_SUFFIX_GUI).asm: $(OBJ_RELEASE_DIR)\Stage$(FILE_SUFFIX_GUI).c
	$(GCC_COMPILER) $(GCC_COMPILER_PARAMETERS_RELEASE) $(OBJ_RELEASE_DIR)\Stage$(FILE_SUFFIX_GUI).c -o $(OBJ_RELEASE_DIR)\Stage$(FILE_SUFFIX_GUI).asm
