...
$(OBJ_RELEASE_DIR)\CreateInstance$(FILE_SUFFIX_GUI).c: Classes\CreateInstance.bas Classes\CreateInstance.bi Classes\EmptyCommand.bi Classes\MoveSelectionRectangleCommand.bi Interfaces\IMoveSelectionRectangleCommand.bi Interfaces\ICommand.bi Classes\DeselectBallCommand.bi Interfaces\IDeselectBallCommand.bi Classes\PushCellCommand.bi Interfaces\IPushCellCommand.bi
...
$(OBJ_RELEASE_DIR)\InputHandler$(FILE_SUFFIX_GUI).c: Classes\InputHandler.bas Classes\InputHandler.bi Classes\Scene.bi Classes\Stage.bi Classes\GameModel.bi Classes\CreateInstance.bi Classes\MoveSelectionRectangleCommand.bi Interfaces\ICommand.bi Interfaces\IMoveSelectionRectangleCommand.bi Classes\DeselectBallCommand.bi Interfaces\IDeselectBallCommand.bi Classes\PushCellCommand.bi Interfaces\IPushCellCommand.bi
